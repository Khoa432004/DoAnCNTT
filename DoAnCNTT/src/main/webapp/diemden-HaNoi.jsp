...
<head>
    ...
    <title>Booking_hotel/Diemden_HaNoi</title>
        ...
        <div class="container d-flex  justify-content-center " style="background-color: #ffffff;">
            ...
            <div class="main-content row mt-2">
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <h4>Thủ Đô Hà Nội - Khách Sạn Và Chỗ Nghỉ</h4>
                    <div id="luachonloc">
                        <ul>
                            ...
                            <li
                                ...
                                <a href="">Được đánh giá hàng đầu</a></li>
                        </ul>
                    </div>
                    <!-----itemt-1----->
                    ...
                    <div class="itemt-1 row ">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/kshn1.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="">Vinhomes Riverside Symphony Apartment <i
                                            class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Hoàn Kiếm,
                                        Hà Nội</p>
                                    <ul>
                                        <p>Nằm ở Quận Long Biên Hà Nội, Vinhomes Riverside Symphony Apartment cung cấp
                                            chỗ nghỉ có hồ bơi riêng và Wi-Fi miễn phí. Khách có thể sử dụng ban công và
                                            hồ bơi ngoài trời mở quanh năm.</p>
                                        <li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HN-1.jsp" %>" 
										   id="datngay2" 
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/kshn2.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="">Nu's Apartment<i class="ti-star"></i><i
                                            class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Đống Đa,
                                        Hà Nội</p>
                                    <ul>
                                        <li>
                                            <p>Nu's Apartment cung cấp hồ bơi riêng và tọa lạc ở Hà Nội. Chỗ nghỉ điều
                                                hòa này cách Trung tâm thương mại Vincom Nguyễn Chí Thanh 6.4 km, khách
                                                có thể sử dụng WiFi miễn phí và chỗ đậu xe riêng có...</p>
                                        </li>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);">2 đêm, 2
                                            người lớn </p>
                                        <del class="giacu">VND 2.450.000 </del>
                                        <p class="giamoi">VND 1.600.000 </p>
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HN-2.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/kshn3.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="">22Housing Condo 8 Nguyen Van Ngoc <i
                                            class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Từ liêm,
                                        Hà Nội</p>
                                    <ul>
                                        <li>
                                            <p>Nhìn ra thành phố, 22Housing Condo 8 Nguyen Van Ngoc nằm ở quận Quận Ba
                                                Đình thuộc Hà Nội, cách Trung tâm thương mại Vincom Nguyễn Chí Thanh
                                                18 phút đi bộ và Bảo tàng dân tộc học Việt Nam 2 km.</p>
                                        </li>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);">1 đêm, 2
                                            người lớn</p>
                                        <del class="giacu">VND 1.740.000 </del>
                                        <p class="giamoi">VND 1.150.000 </p>
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HN-3.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/kshn5.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="">22Housing Luxury Apartment near lotte towerMở trong cửa
                                        sổ mới
                                        <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Quận Đống
                                        Đa, Hà Nội</p>
                                    <ul>
                                        <li>
                                            <p>Tọa lạc ở Hà Nội, 22Housing Luxury Apartment near lotte tower nhìn ra
                                                khu vườn, có Wi-Fi miễn phí và cách Trung tâm thương mại Vincom Nguyễn
                                                Chí Thanh 18 phút đi bộ cũng như Bảo tàng dân tộc học...</p>
                                        </li>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HN-4.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/HCM-5.1.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="">MiaCasaHanoi
                                    ...
                                    <ul>
                                        <li>
                                            <p>Tọa lạc cách Văn Miếu - Quốc Tử Giám 14 phút đi bộ, MiaCasaHanoi cung cấp
                                                chỗ nghỉ có khu vườn, sân hiên và bếp chung. WiFi và chỗ đậu xe riêng
                                                đều có sẵn tại khách sạn căn hộ miễn phí.</p>
                                        </li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HN-5.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>

        ...
        <div class="container d-flex  justify-content-center " style="background-color: #ffffff;">
            ...
            <div class="main-content row mt-2">
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <h4 style="font-weight: 600; font-size: 18px; color: #1F4456;">THE SONG Apartment</h4>
                    ...
                    <div class="mt-2 row" style="width: 100%;">
                        <img style="width: 100%;" src="assets/img/VT-2.jpg" alt="">
                    </div>

                    <div class="row mt-2" style="margin-left: 4px; width:  98%;">
                        <div class="anh1 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-2.1.jpg" alt="">
                        </div>

                        <div class="anh2 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-2.2.jpg" alt="">
                        </div>

                        <div class="anh4 col-sm-4" style="margin: 0px;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-2.3.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="text-hotel row mt-3">
                    <div class="text-midle col-sm-4" style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
                        ...
                        <p style="margin-left: 20px; font-size: 15px; color: gray;">Cách Bãi Sau 9 phút đi bộ, CĂN HỘ 5
                            SAO THE SÓNG VŨNG TÀU Mr VƯƠNG có hồ bơi ngoài trời, khu vườn, điều hòa, ban công và Wi-Fi
                            miễn phí. Chỗ đậu xe riêng có sẵn trong khuôn viên.
                            Mỗi căn đều có sân hiên nhìn ra thành phố, TV màn hình phẳng, bếp tiện nghi, cùng phòng tắm
                            riêng có vòi xịt/chậu rửa vệ sinh, đồ vệ sinh cá nhân miễn phí và máy sấy tóc. Tủ lạnh, lò
                            vi sóng và bếp, cũng như ấm đun nước đều được cung cấp.</p>
                    </div>
                            ...
                            <div class="col">
                                <ul style="border-left: none;">
                                    ...
                                    <li style="list-style: none; margin-bottom: 10px;"> <i class="ti-location-pin">Tượng
                                            Chúa Ki-tô 3.4 km</i></li>
                                    <li> <i class="ti-location-pin">Khu du lịch sinh thái văn hóa Hồ Mây 3.8 km.</i>
                                    </li>
                                </ul>
                            </div>
                            <div class="col">
                ...
                <!-----itemt-1----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP05">
                <div class="itemt-1 row mt-4" id="phongtrong">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-2.1.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Căn Hộ 1 Phòng Ngủ</a>
                                <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Tầng 4</p>
                                <ul>
                                    <li>
                                        <p>Căn này được trang bị 1 giường view biển</p>
                                    </li>
                                    <li>
                                        <p>1 Phòng Ngủ • 1 Ban Công • 1 phòng khách • 1 phòng tắm • 1 phòng bếp 25m²
                                        </p>
                                    </li>
                                    <li>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP05" style="display: none;">
                ...
                <!-----itemt-2----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP06">
                <div class="itemt-1 row mt-2">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-2.2.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Căn Hộ 2 Phòng Ngủ</a>
                                <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Tầng 5</p>
                                <ul>
                                    <li>
                                        <p>2 Phòng Ngủ • 1 Ban Công • 1 phòng khách • 1 phòng tắm • 1 phòng bếp 25m²
                                        </p>
                                    </li>
                                    <li>
                                        <p>Sẵn có: Đồ vệ sinh cá nhân miễn phí • Dép • Áo Choàng Tắm • Máy Sấy Tóc</p>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <p class="giamoi">VND 2.000.000 </p>
                                    <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm thuế
                                        và phí</p>
                                    <br>
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP06" style="display: none;">
                                    <!-- Modal trigger button -->
                                    <button type="submit" class="btn-datphong btn btn-primary  btn-success mt-2"
                                        data-bs-toggle="modal" data-bs-target="#modalId" data-money="2000000">
                                        Đặt Phòng Ngay<i style="color: white;" class="ti-angle-right"></i>
                                    </button>
                                </div>
                            </div>
                ...
                <!-----itemt-3----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP07">
                <div class="itemt-1 row mt-2">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-2.3.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Căn Hộ 3 Phòng Ngủ</a>
                                <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Tầng 4</p>
                                <ul>
                                    <li>
                                        <p>Căn Hộ 3 phòng ngủ cực rộng</p>
                                    </li>
                                    <li>
                                        <p>3 Phòng Ngủ • 1 phòng khách • 1 phòng tắm • 1 phòng bếp • 65m²</p>
                                    </li>
                                    <li>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <br>
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP07" style="display: none;">
                                    <!-- Modal trigger button -->
                                    <button type="submit" class="btn-datphong btn btn-primary  btn-success mt-2"

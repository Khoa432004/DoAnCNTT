...
<body>
	...
	<div class="content d-flex justify-content-center mt-3">
		<div class="main-content row ">
			...
			<div class="text-sub-2 text-center mt-3">
				<p>
					Qua việc đăng nhập hoặc tạo tài khoản, bạn đồng ý với các <a
						href="">Điều khoản và Điều kiện</a> cũng như <a href="">Chính
						sách An toàn và Bảo mật</a> của chúng tôi
				</p>
	...
	<script src="assets/javaScript/dangky.js"></script>

        ...
        <div class="container d-flex  justify-content-center " style="background-color: #ffffff;">
            ...
            <div class="main-content row mt-2">
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <h4 style="font-weight: 600; font-size: 18px; color: #1F4456;">The Land Hotel & Apartment
                            </h4>
                            <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                class="ti-star"></i><i class="ti-star"></i>
                            <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí: 91 Phan
                                Chu Trinh, Phường 2, Thành Phố Vũng Tàu, Vũng Tàu, Việt Nam</p>
                        </div>
                    ...
                    <div class="mt-2 row" style="width: 100%;">
                        <img style="width: 100%;" src="assets/img/VT-4.jpg" alt="">
                    </div>

                    <div class="row mt-2" style="margin-left: 4px; width:  98%;">
                        <div class="anh1 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-4.1.jpg" alt="">
                        </div>

                        <div class="anh2 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-4.2.jpg" alt="">
                        </div>

                        <div class="anh4 col-sm-4" style="margin: 0px;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-4.3.jpg" alt="">
                        </div>
                    </div>
                ...
                <div class="text-hotel row mt-3">
                    <div class="text-midle col-sm-4" style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
                        ...
                        <p style="margin-left: 20px; font-size: 15px; color: gray;">Nằm ở Vũng Tàu, cách Bãi Sau 14
                            phút đi bộ, The Land Hotel & Apartment cung cấp chỗ nghỉ có phòng chờ chung, chỗ đậu xe
                            riêng miễn phí và sân hiên. Ngoài Wi-Fi miễn phí, khách sạn 3 sao này còn cung cấp bếp chung
                            và dịch vụ phòng. Chỗ nghỉ này cung cấp quầy lễ tân 24 giờ, dịch vụ tiền sảnh và phòng giữ
                            hành lý cho khách.</p>
                    </div>
                        ...
                        <div class="text-1 row ">
                            <div class="col">
                                <ul style="border-left: none;">
                                    ...
                                    <li style="list-style: none; margin-bottom: 10px;"> <i class="ti-location-pin">Địa
                                            điểm nổi tiếng Mũi Nghinh Phong</i></li>
                                    <li> <i class="ti-location-pin">Địa điểm nổi tiếng Bãi Tước</i></li>
                                </ul>
                            </div>
                            <div class="col">
                                <ul style="border-left: none;">
                ...
                <!-----itemt-1----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP12">
                <div class="itemt-1 row mt-4" id="phongtrong">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-4.1.jpg" alt="">
                    </div>
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p>1 Giường ngủ • 1 Ban Công • 1 phòng khách • 1 phòng tắm • 1 phòng bếp 55m²
                                        </p>
                                    </li>
                                    <li>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP12" style="display: none;">
                ...
                <!-----itemt-2----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP13">
                <div class="itemt-1 row mt-2">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-4.2.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Phòng Giường Đôi có Ban công và Nhìn ra Biển</a>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <br>
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP13" style="display: none;">
                                    <!-- Modal trigger button -->
                                    <button type="button" class="btn-datphong btn btn-primary  btn-success mt-2"
                ...
                <!-----itemt-3----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP14">
                <div class="itemt-1 row mt-2">

                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-4.3.jpg" alt="">
                    </div>
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p>2 giường ngủ • 1 phòng khách • 1 phòng tắm • 1 phòng bếp • 65m²</p>
                                    </li>
                                    <li>
                            ...
                            <div class="text-right col-sm">
                                ...
                                <div class="itemt-price  text-center">
                                    ...
                                    <br>
                                    <input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP14" style="display: none;">
                                    <!-- Modal trigger button -->
                                    <button type="button" class="btn-datphong btn btn-primary  btn-success mt-2"

			...
			<div class="main-content row mt-2">
				...
				<div class="content-sidebar col-sm-3">
					...
					<div class="loc-container mt-2"
						...
						<p style="font-weight: 600; font-size: 16px; color: #1F4456;">Khách
							sạn tương tự:</p>
							...
							<div class="itemt-text col-sm">
								...
								<div class="text-1  ">
									<div class="text-left col-sm">
										<a id="itemt-title" href="VT-1.jsp" style="font-size: 13px;">Fati
											Boutique Hotel & Apartment</a>
										<p style="color: black; font-size: 13px;">
											<i class="ti-location-pin"></i> Vị trí: Phường 5, Vũng Tàu
										</p>
									</div>
								</div>
						...
						<div class="itemt-1 row mt-2">
							...
							<div class="itemt-text col-sm">
								...
								<div class="text-1  ">
									<div class="text-left col-sm">
										<a id="itemt-title" href="VT-2.jsp" style="font-size: 13px;">THE
											SONG Apartment</a>
										<p style="color: black; font-size: 13px;">
											<i class="ti-location-pin"></i> Vị trí: Đường Thi Sách, Vũng
											Tàu
										</p>
									</div>
								</div>
						...
						<div class="itemt-1 row mt-2">
							...
							<div class="itemt-text col-sm">
								...
								<div class="text-1  ">
									<div class="text-left col-sm">
										<a id="itemt-title" href="VT-3.jsp" style="font-size: 13px;">The
											Land Hotel & Apartment </a>
										<p style="color: black; font-size: 13px;">
											<i class="ti-location-pin"></i> Vị trí: Đường Thi Sách, Vũng
											Tàu
										</p>
									</div>
								</div>
						...
						<div class="itemt-1 row mt-2">
							...
							<div class="itemt-text col-sm">
								...
								<div class="text-1  ">
									<div class="text-left col-sm">
										<a id="itemt-title" href="VT-4.jsp" style="font-size: 13px;">The
											Land Hotel & Apartment<i class="ti-star"></i><i
											class="ti-star"></i><i class="ti-star"></i>
										</a>
										<p style="color: black; font-size: 13px;">
											<i class="ti-location-pin"></i> Vị trí: Phường 2, Vũng Tàu
										</p>
									</div>
								</div>
						...
						<div class="itemt-1 row mt-2">
							...
							<div class="itemt-text col-sm">
								...
								<div class="text-1  ">
									<div class="text-left col-sm">
										<a id="itemt-title" href="VT-5.jsp" style="font-size: 13px;">V
											Boutique Hotel<i class="ti-star"></i><i class="ti-star"></i><i
											class="ti-star"></i>
										</a>
										<p style="color: black; font-size: 13px;">
											<i class="ti-location-pin"></i> Vị trí: Phan Huy Ich, Vũng
											Tàu, Việt Nam
										</p>
									</div>
								</div>
				...
				<div class="content-itemt col-sm ">
					...
					<div class="row">
						<div class="col-sm-7">
							<h4 style="font-weight: 600; font-size: 18px; color: #1F4456;">Fati
								Boutique Hotel & Apartment</h4>
							<i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
								class="ti-star"></i><i class="ti-star"></i>
							<p style="color: black; font-size: 13px;">
								<i class="ti-location-pin"></i> Vị trí: 112/3 Trần Phú Tòa nhà
								Fati Boutique, 112/3 Trần Phú, Phường 5, Vũng Tàu, Việt
								Nam
							</p>
						</div>
						...
						<div class="col-sm" style="margin-left: 125px">
							<p
								style="margin-left: 90px; margin-bottom: 0; font-size: 14px; color: rgb(90, 90, 90);">
								Giá chỉ từ</p>
							<p class="giamoi"
								style="margin: 0; color: #2F8BD8; font-weight: 600; margin-left: 70px;">VND
								1.000.000</p>
							<a href="#phongtrong" class="btn btn-primary   "
								style="width: 180px; margin-left: 30px;"> Đặt Ngay </a>
						</div>
					</div>


					<div class="mt-2 row" style="width: 100%;">
						<img style="width: 100%;" src="assets/img/VT-1.jpg" alt="">
					</div>

					<div class="row mt-2" style="margin-left: 4px; width: 98%;">
						<div class="anh1 col-sm-4" style="margin: 0; padding: 0;">
							<img style="width: 95%; height: 100%;"
								src="assets/img/VT-1.1.jpg" alt="">
						</div>

						<div class="anh2 col-sm-4" style="margin: 0; padding: 0;">
							<img style="width: 95%; height: 100%;"
								src="assets/img/VT-1.2.jpg" alt="">
						</div>

						<div class="anh4 col-sm-4" style="margin: 0px; padding: 0;">
							<img style="width: 95%; height: 100%;"
								src="assets/img/VT-1.3.jpg" alt="">
						</div>
					</div>
				</div>
				...
				<div class="text-hotel row mt-3">
					<div class="text-midle col-sm-4"
						style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
						<p style="margin-left: 20px; font-weight: 600;">Giới thiệu cơ
							sở lưu trú:</p>
						<p style="margin-left: 20px; font-size: 15px; color: gray;">Nằm
							ở Vũng Tàu, cách Bãi Dâu chỉ vài bước chân, Fati Boutique Hotel
							& Apartment cung cấp chỗ nghỉ có hồ bơi ngoài trời, chỗ đậu xe
							riêng miễn phí và khu vườn. Chỗ nghỉ này có Wi-Fi miễn phí, nằm
							cách Bạch Dinh 2.8 km và Khu du lịch sinh thái văn hóa Hồ Mây 5
							km. Chỗ nghỉ này cung cấp dịch vụ phòng và quầy lễ tân 24 giờ cho
							khách.</p>
					</div>
						...
						<div class="text-1 row ">
							<div class="col">
								<ul style="border-left: none;">
									<li style="list-style: none; margin-bottom: 10px;"><i
										class="ti-game" style="color: rgb(0, 153, 255);"></i> <i>
											Gần khu vui chơi, giải trí</i></li>
									<li style="list-style: none; margin-bottom: 10px;"><i
										class="ti-location-pin">Tượng Chúa Ki-tô 6.6 km</i></li>
									<li><i class="ti-location-pin">Hải đăng Vũng Tàu 6.8
											km.</i></li>
								</ul>
							</div>
							<div class="col">
								<ul style="border-left: none;">
									<li style="list-style: none; margin-bottom: 10px;"><i
										class="ti-location-pin">Vũng Tàu Beach</i></li>
				...
				<div class="text-hotel row mt-3">
					<div class="text-left col-sm-4"
						style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
						<p style="margin-left: 20px; font-weight: 600;">Tiện ích
							chính:</p>
						<ul>
							<li><i class="ti-rss-alt" style="color: rgb(0, 153, 255);">
									Wifi</i></li>
							<li><i class="ti-car" style="color: rgb(0, 153, 255);">
									Bãi đậu xe</i></li>
							<li><i class="ti-headphone-alt"
								style="color: rgb(0, 153, 255);"> Lễ tân 24/24</i></li>
							<li><i class="ti-trash" style="color: rgb(0, 153, 255);">
									Sạch sẽ, gọn gàng</i></li>
							<li><i class="ti-shopping-cart"
								style="color: rgb(0, 153, 255);"> Có khu vực mua sắm</i></li>
							<li></li>
						</ul>
					</div>
				...
				<h4 style="margin-top: 30px;">Những phòng còn trống tại khách
					sạn:</h4>
				<img style="width: 99%;" src="assets/img/chitietphong.png" alt="">

				<!-----itemt-1----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP01">
					<div class="itemt-1 row mt-4" id="phongtrong">

						<div class="itemt-anh col-sm-4">
							<img src="assets/img/VT-1.4.jpg" alt="">
						</div>
						...
						<div class="itemt-text col-sm">
							...
							<div class="text-1  row ">
								<div class="text-left col-sm-8">
									...
									<p style="color: black; font-size: 13px;">
										<i class="ti-location-pin"></i>Tầng 4
									</p>
									<ul>
										<li>
											<p>Căn này được trang bị 1 giường</p>
										</li>
										<li>
											<p>1 Giường ngủ • 1 Ban Công • 1 phòng khách • 1 phòng
												tắm • 1 phòng bếp 25m²</p>
										</li>
										<li>
											<p>Sẵn có: Đồ vệ sinh cá nhân miễn phí • Dép • Áo Choàng
												Tắm • Máy Sấy Tóc</p>
										</li>
										<li>
											<p>
												<i class="ti-check"></i> <b style="color: green;">Miễn
													phí hủy</b>
											</p>
										</li>
										<li>
											<p>
												<i class="ti-check"></i> <b style="color: green;">Không
													cần thanh toán trước</b> – thanh toán tại chỗ nghỉ
											</p>
										</li>
									</ul>
								</div>
								...
								<div class="text-right col-sm">
									...
									<div class="itemt-comment" style="height: 60px;"></div>

									<div class="itemt-price  text-center">
										<p
											style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);">1
											đêm, 2 người lớn</p>
										<del class="giacu">VND 1.140.000 </del>
										<p class="giamoi">VND 1.000.000</p>
										<p
											style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);">Đã
											bao gồm thuế và phí</p>
										<input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP01" style="display: none;">
										<br>
										<!-- Modal trigger button -->
										<button type="submit"
											class="btn-datphong btn btn-primary  btn-success mt-2"
				...
				<!-----itemt-2----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP02">
					<div class="itemt-1 row mt-2">
	
						<div class="itemt-anh col-sm-4">
							<img src="assets/img/VT-1.5.jpg" alt="">
						</div>
						...
						<div class="itemt-text col-sm">
							...
							<div class="text-1  row ">
								<div class="text-left col-sm-8">
									<a id="itemt-title" href="">Phòng Giường Đôi có Ban công và
										Nhìn ra Biển</a>
									<p style="color: black; font-size: 13px;">
										<i class="ti-location-pin"></i>Tầng 5
									</p>
									<ul>
										<li>
											<p>1 Giường ngủ • 1 Ban Công • 1 phòng khách • 1 phòng tắm
												• 1 phòng bếp 25m²</p>
										</li>
										<li>
											<p>Sẵn có: Đồ vệ sinh cá nhân miễn phí • Dép • Áo Choàng
								...
								<div class="text-right col-sm">
									...
									<div class="itemt-price  text-center">
										...
										<p
											...
											bao gồm thuế và phí</p>
										<input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP02" style="display: none;">
										<br>
										<!-- Modal trigger button -->
										<button type="submit"
											class="btn-datphong btn btn-primary  btn-success mt-2"
				...
				<!-----itemt-3----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP03">
					<div class="itemt-1 row mt-2">
	
						<div class="itemt-anh col-sm-4">
							<img src="assets/img/VT-1.6.jpg" alt="">
						</div>
						...
						<div class="itemt-text col-sm">
							...
							<div class="text-1  row ">
								<div class="text-left col-sm-8">
									<a id="itemt-title" href="">Studio Superior</a>
									<p style="color: black; font-size: 13px;">
										<i class="ti-location-pin"></i>Tầng 4
									</p>
									<ul>
										<li>
											<p>Căn Hộ 2 giường ngủ</p>
										</li>
										<li>
											<p>2 giường ngủ • 1 phòng khách • 1 phòng tắm • 1 phòng
												bếp • 65m²</p>
										</li>
										<li>
								...
								<div class="text-right col-sm">
									...
									<div class="itemt-price  text-center">
										...
										<p
											...
											bao gồm thuế và phí</p>
										<input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP03" style="display: none;">
										<br>
										<!-- Modal trigger button -->
										<button type="submit"
											class="btn-datphong btn btn-primary  btn-success mt-2"
				...
				<!-----itemt-4----->
				<form action="addmaloaiphong" method="post" class="form-roomtype-LP04">
					<div class="itemt-1 row mt-2">
	
						<div class="itemt-anh col-sm-4">
							<img src="assets/img/VT-1.7.jpg" alt="">
						</div>
						...
						<div class="itemt-text col-sm">
							...
							<div class="text-1  row ">
								<div class="text-left col-sm-8">
									...
									<p style="color: black; font-size: 13px;">
										<i class="ti-location-pin"></i>Tầng 3
									</p>
									<ul>
										<li>
								...
								<div class="text-right col-sm">
									...
									<div class="itemt-price  text-center">
										...
										<p
											...
											bao gồm thuế và phí</p>
										<input class="form-control" type="text" name="MaLoaiPhong"
											id="MaLoaiPhong" value="LP04" style="display: none;">
										<br>
										<!-- Modal trigger button -->
										<button type="submit"
											class="btn-datphong btn btn-primary  btn-success mt-2"

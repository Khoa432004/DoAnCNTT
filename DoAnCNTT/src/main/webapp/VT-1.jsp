        ...
        <div class="container d-flex  justify-content-center " style="background-color: #ffffff;">
            ...
            <div class="main-content row mt-2">
                    ...
                    <div class="loc-container mt-2"
                        ...
                        <div class="itemt-1 row mt-2">
                            ...
                            <div class="itemt-text col-sm">
                                ...
                                <div class="text-1  ">
                                    <div class="text-left col-sm">
                                        <a id="itemt-title" href="VT-5.jsp" style="font-size: 13px;">V Boutique
                                            Hotel<i class="ti-star"></i><i class="ti-star"></i><i
                                                class="ti-star"></i></a>
                                        <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <h4 style="font-weight: 600; font-size: 18px; color: #1F4456;">Fati Boutique Hotel &
                                Apartment</h4>
                            <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                class="ti-star"></i><i class="ti-star"></i>
                            <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí: 112/3
                                Trần Phú Tòa nhà Fati Boutique, 112/3 Trần Phú, Phường 5, Vũng Tàu, Việt Nam</p>
                        </div>
                    ...
                    <div class="row mt-2" style="margin-left: 4px; width:  98%;">
                        <div class="anh1 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-1.1.jpg" alt="">
                        </div>

                        <div class="anh2 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-1.2.jpg" alt="">
                        </div>

                        <div class="anh4 col-sm-4" style="margin: 0px;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-1.3.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="text-hotel row mt-3">
                    <div class="text-midle col-sm-4" style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
                        ...
                        <p style="margin-left: 20px; font-size: 15px; color: gray;">Nằm ở Vũng Tàu, cách Bãi Dâu chỉ
                            vài bước chân, Fati Boutique Hotel & Apartment cung cấp chỗ nghỉ có hồ bơi ngoài trời, chỗ
                            đậu xe riêng miễn phí và khu vườn. Chỗ nghỉ này có Wi-Fi miễn phí, nằm cách Bạch Dinh 2.8
                            km và Khu du lịch sinh thái văn hóa Hồ Mây 5 km. Chỗ nghỉ này cung cấp dịch vụ phòng và quầy
                            lễ tân 24 giờ cho khách.</p>
                    </div>

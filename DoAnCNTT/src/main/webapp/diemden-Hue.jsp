...
<head>
    ...
    <title>Booking_hotel/Diemden_Hue</title>
...
<body>
            ...
            <div class="main-content row mt-2">
                <div id="duongdanvitri">
                    <ul>
                        ...
                        <li><i class="ti-angle-right"> </i></li>
                        <li><a href="diemden-HoChiMinh.jsp">Huế</a></li>
                    </ul>
                </div>

                <div class="content-sidebar col-sm-3">
                    <div class="goole-map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122445.89346102126!2d107.49471086582949!3d16.453538995595142!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a115e1a7935f%3A0xbf3b50af70b5c7b7!2zVHAuIEh14bq_LCBUaOG7q2EgVGhpw6puIEh14bq_LCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1715335764189!5m2!1svi!2s" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <h4>TP.Huế - Khách Sạn Và Chỗ Nghỉ</h4>
                    <div id="luachonloc">
                        <ul>
                    ...
                    <div class="itemt-1 row ">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/HUE-1.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="HUE-1.jsp">
                                    ...
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí:
                                        Huế</p>
                                    <ul>
                                        <p>Pilgrimage Village Boutique Resort & Spa là resort mộc mạc nằm trong khu vực
                                            yên tĩnh thuộc tỉnh Thừa Thiên Huế.</p>
                                        <li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                        <a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HUE-1.jsp" %>" 
										   id="datngay2" 
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4" style="height: 200px;">
                            <img src="assets/img/HUE-2.jpg" alt="">
                        </div>

                        <div class="itemt-text col-sm">
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="HUE-2.jsp">Hue Sweethouse 1 Homestay<i
                                            class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị
                                        trí: Huế</p>
                                    <ul>
                                        <p>Hue Sweethouse 1 Homestay ở Huế tọa lạc cách Cầu Tràng Tiền 13 phút đi bộ,
                                            cung cấp chỗ nghỉ có điều hòa, Wi-Fi miễn phí, cũng như sân hiên.</p>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                    </ul>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
										<a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HUE-2.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row ">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/HUE-3.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="HUE-3.jsp">
                                        Tâm Homestay
                                        <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí:
                                        Huế</p>
                                    <ul>
                                        <p>Nằm ở Huế, cách Cầu Tràng Tiền 15 phút đi bộ và Chợ Đông Ba 1.9 km, Tâm
                                            Homestay cung cấp chỗ nghỉ có Wi-Fi miễn phí, điều hòa, khu vườn và phòng
                                            chờ chung.</p>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
										<a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HUE-3.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4">
                            <img src="assets/img/HUE-4.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="HUE-4.jsp">
                                        Thuy Duong Boutique Hotel Hue
                                        <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí:
                                        Huế</p>
                                    <ul>
                                        <p>Nằm gần Sông Hương, Thuy Duong Boutique Hotel Hue cách ga tàu, trạm xe buýt
                                            và Chợ Đông Ba 10 phút lái xe. Nơi đây cung cấp các phòng giá cả phải chăng
                                            với Wi-Fi miễn phí và nhà hàng.</p>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                        <li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
										<a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HUE-4.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
                    ...
                    <div class="itemt-1 row mt-2">
                        ...
                        <div class="itemt-anh col-sm-4" style="height: 200px;">
                            <img src="assets/img/HUE-5.jpg" alt="">
                        </div>
                        ...
                        <div class="itemt-text col-sm">
                            ...
                            <div class="text-1  row ">
                                <div class="text-left col-sm-8">
                                    <a id="itemt-title" href="HUE-5.jsp">
                                        Vina Center Hotel
                                        <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                            class="ti-star"></i><i class="ti-star"></i></a>
                                    <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Vị trí:
                                        Huế</p>
                                    <ul>
                                        <p>Tọa lạc cách Cầu Tràng Tiền 13 phút đi bộ, Vina Center Hotel cung cấp chỗ
                                            nghỉ 3 sao ở Huế, đồng thời có sân hiên, nhà hàng và quầy bar.</p>
                                        <li>
                                            <p> <i class="ti-check"></i> <b style="color: green;">Miễn phí hủy</b></p>
                                        </li>
                                        <li>
                                ...
                                <div class="text-right col-sm">
                                    ...
                                    <div class="itemt-price  text-center">
                                        ...
                                        <p style="width: 100%; font-size: 11px; color: rgb(100, 100, 100);;">Đã bao gồm
                                            thuế và phí</p>
                                      	<a href="<%= (session.getAttribute("Username") == null) ? "dangnhap.jsp" : "HUE-5.jsp" %>" 
										   id="datngay2" 
										   class="btn btn-success mt-2">
										   Đặt Phòng Ngay <i style="color: white;" class="ti-angle-right"></i>
										</a>
    ...
    <script src=" assets/javaScript/trangchu.js">
    </script>

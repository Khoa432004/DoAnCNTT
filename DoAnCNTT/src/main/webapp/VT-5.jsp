        ...
        <div class="container d-flex  justify-content-center " style="background-color: #ffffff;">
            ...
            <div class="main-content row mt-2">
                ...
                <div class="content-itemt col-sm ">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <h4 style="font-weight: 600; font-size: 18px; color: #1F4456;">V Boutique Hotel</h4>
                            <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
                                class="ti-star"></i><i class="ti-star"></i>
                            <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i> Vị trí: 32 Phan
                                Huy Ich, Vũng Tàu, Việt Nam</p>
                        </div>
                    ...
                    <div class="mt-2 row" style="width: 100%;">
                        <img style="width: 100%;" src="assets/img/VT-5.jpg" alt="">
                    </div>

                    <div class="row mt-2" style="margin-left: 4px; width:  98%;">
                        <div class="anh1 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-5.1.jpg" alt="">
                        </div>

                        <div class="anh2 col-sm-4" style="margin: 0;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-5.2.jpg" alt="">
                        </div>

                        <div class="anh4 col-sm-4" style="margin: 0px;padding: 0;">
                            <img style="width: 95%; height: 100%;" src="assets/img/VT-5.3.jpg" alt="">
                        </div>
                    </div>
                ...
                <div class="text-hotel row mt-3">
                    <div class="text-midle col-sm-4" style="border: 1px solid rgb(235, 234, 234); border-radius: 8px;">
                        ...
                        <p style="margin-left: 20px; font-size: 15px; color: gray;">Nằm ở Vũng Tàu, cách Bãi Sau 13
                            phút đi bộ, V Boutique Hotel - Complimentary refreshments cung cấp chỗ nghỉ có hồ bơi ngoài
                            trời, chỗ đậu xe riêng miễn phí và khu vườn. Ngoài dịch vụ tiền sảnh, chỗ nghỉ này còn có
                            công viên nước. Chỗ nghỉ cung cấp lễ tân 24/24, dịch vụ đưa đón sân bay, dịch vụ phòng và
                            Wi-Fi miễn phí ở toàn bộ chỗ nghỉ.</p>
                    </div>
                        ...
                        <div class="text-1 row ">
                            <div class="col">
                                <ul style="border-left: none;">
                                    ...
                                    <li style="list-style: none; margin-bottom: 10px;"> <i class="ti-location-pin">Bãi
                                            Trước 16 phút đi bộ</i></li>
                                    <li> <i class="ti-location-pin">Bãi Dứa 3 km.</i></li>
                                </ul>
                            </div>
                            <div class="col">
                                <ul style="border-left: none;">
                ...
                <div class="itemt-1 row mt-4" id="phongtrong">
                    ...
                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-5.1.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Phòng giường đôi</a>
                ...
                <div class="itemt-1 row mt-2">
                    ...
                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-5.2.jpg" alt="">
                    </div>
                ...
                <div class="itemt-1 row mt-2">
                    ...
                    <div class="itemt-anh col-sm-4">
                        <img src="assets/img/VT-5.3.jpg" alt="">
                    </div>
                    ...
                    <div class="itemt-text col-sm">
                        ...
                        <div class="text-1  row ">
                            <div class="text-left col-sm-8">
                                <a id="itemt-title" href="">Phòng Gia Đình Có Ban Công</a>
                                <p style="color: black; font-size: 13px; "><i class="ti-location-pin"></i>Tầng 4</p>
                                <ul>
                                    <li>
